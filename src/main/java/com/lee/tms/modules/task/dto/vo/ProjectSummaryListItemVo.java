...
@Data
public class ProjectSummaryListItemVo
{
    /**
     * 内部序号
     */
    ...
    public static ProjectSummaryListItemVo fromModel(ProjectSummary e)
    {
        ProjectSummaryListItemVo vo = new ProjectSummaryListItemVo();
